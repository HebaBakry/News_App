...
class AppTheme {
  ...
  static const Color primaryContainer = Color(0xFFFFFCFC);
  static const Color onPrimaryContainer = Colors.transparent;
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        onPrimaryContainer: onPrimaryContainer, // Secondary color
      ),
